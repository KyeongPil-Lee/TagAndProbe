...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("Effciency_ZMuMu_DoubleVoigPlusExpo_RecoIDIso_PUPPI_2Dbin.root"),
    ...
    Efficiencies = cms.PSet(
        IDTight_PFIsoPUPPI = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("passingHLT_Mu17Mu8dzIsoVVL", "true", "dzPV_lower", "above", "dzPV_upper", "below", "passingTight", "true", "RelPFIso_PUPPI12", "below"),
